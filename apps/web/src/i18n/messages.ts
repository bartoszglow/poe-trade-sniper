...
export const EN = {
  ...
  'hitCard.buyRetryTitle': 'Re-check the listing for a fresh token, then buy',
  'hitCard.expired': 'expired',
  'hitCard.locateSearch': 'Show the source search',
  'hitCard.marketContext': 'market ≈ {price}',
  ...
  'searches.archiveAction': 'Archive',
  'searches.pausedTag': 'PAUSE',
  ...
  'searches.marketPriceTip': 'Approximate market price · from {sample} cheapest listings',
  ...
  // Deal-watch — status codes (shared by row chip, modal, tooltips)
  'dealWatch.status.active': 'Deal watch active',
  'dealWatch.status.paused': 'Deal watch paused',
  'dealWatch.status.pending-derive': 'Setting up the capped search…',
  'dealWatch.status.insufficient-data': 'Too few listings for a reliable market price',
  'dealWatch.status.baseline-stale': 'Market price is stale — alerts still fire, flagged',
  'dealWatch.status.derive-failed': 'Could not update the capped search — retrying',
  'dealWatch.status.derive-conflict': 'Capped search collides with another watched search',
  'dealWatch.status.derived-expired': 'Capped search expired — recreating',
  'dealWatch.status.unsupported-item': 'Item type not supported by deal watch yet',
  'dealWatch.status.capped': 'Deal-watch limit reached — this watch is parked',
  'dealWatch.status.restore-failed': 'Could not restore the original search — retry disabling',
  ...
  'dealWatch.thresholdLabel': 'Threshold',
  ...
  'dealWatch.buyBelow': 'Buy below',
  'dealWatch.baselineMissing': 'No baseline yet',
  'dealWatch.rawLowest': 'Lowest listing',
  'dealWatch.sampleOf': '{sample} of {seen} listings',
  'dealWatch.checkedAgo': 'checked {time} ago',
  ...
  'dealWatch.refreshCta': 'Refresh market price',
  'dealWatch.refreshCooldown': 'Refresh available in {seconds}s',
  'dealWatch.refreshDeclined.archived': 'Refresh declined — the search is archived',
  'dealWatch.refreshDeclined.disabled': 'Refresh declined — the search is inactive',
  'dealWatch.refreshDeclined.paused': 'Refresh declined — detection is paused',
  'dealWatch.refreshDeclined.guard-tripped': 'Refresh declined — the safety guard is tripped',
  'dealWatch.disableCta': 'Disable deal watch',
  'dealWatch.disableConfirmTitle': 'Disable deal watch?',
  'dealWatch.disableConfirmBody':
    '"{label}" goes back to its original trade search and price filter.',
  'dealWatch.disableConfirmPaused':
    'Detection is paused — the trade-site restore runs when it resumes.',
  ...
  'dealWatch.refreshEvery.15m': '15 minutes',
...
export const PL: Record<MessageKey, string> = {
  ...
  'hitCard.buyRetryTitle': 'Sprawdź ofertę ponownie po świeży token, potem kup',
  'hitCard.expired': 'wygasł',
  'hitCard.locateSearch': 'Pokaż wyszukiwanie źródłowe',
  'hitCard.marketContext': 'rynek ≈ {price}',
  ...
  'searches.archiveAction': 'Archiwizuj',
  'searches.pausedTag': 'PAUZA',
  ...
  'searches.marketPriceTip': 'Przybliżona cena rynkowa · z {sample} najtańszych ofert',
  ...
  // Deal-watch — statusy (wspólne dla chipa, modala, tooltipów)
  'dealWatch.status.active': 'Obserwacja okazji aktywna',
  'dealWatch.status.paused': 'Obserwacja okazji wstrzymana',
  'dealWatch.status.pending-derive': 'Przygotowywanie wyszukiwania z limitem…',
  'dealWatch.status.insufficient-data': 'Za mało ofert, by wyznaczyć wiarygodną cenę rynkową',
  'dealWatch.status.baseline-stale': 'Cena rynkowa nieaktualna — alerty dalej działają, oznaczone',
  'dealWatch.status.derive-failed': 'Nie udało się zaktualizować wyszukiwania — ponawianie',
  'dealWatch.status.derive-conflict': 'Wyszukiwanie z limitem koliduje z innym obserwowanym',
  'dealWatch.status.derived-expired': 'Wyszukiwanie z limitem wygasło — odtwarzanie',
  'dealWatch.status.unsupported-item': 'Ten typ przedmiotu nie jest jeszcze wspierany',
  'dealWatch.status.capped': 'Osiągnięto limit obserwacji okazji — ta czeka',
  'dealWatch.status.restore-failed':
    'Nie udało się przywrócić oryginalnego wyszukiwania — ponów wyłączenie',
  ...
  'dealWatch.buyBelow': 'Kupuj poniżej',
  'dealWatch.baselineMissing': 'Brak ceny bazowej',
  'dealWatch.rawLowest': 'Najniższa oferta',
  'dealWatch.sampleOf': '{sample} z {seen} ofert',
  'dealWatch.checkedAgo': 'sprawdzono {time} temu',
  'dealWatch.warnStale':
  ...
  'dealWatch.refreshCta': 'Odśwież cenę rynkową',
  'dealWatch.refreshCooldown': 'Odświeżanie dostępne za {seconds}s',
  'dealWatch.refreshDeclined.archived': 'Odświeżenie odrzucone — wyszukiwanie jest zarchiwizowane',
  'dealWatch.refreshDeclined.disabled': 'Odświeżenie odrzucone — wyszukiwanie jest nieaktywne',
  'dealWatch.refreshDeclined.paused': 'Odświeżenie odrzucone — detekcja jest wstrzymana',
  'dealWatch.refreshDeclined.guard-tripped': 'Odświeżenie odrzucone — bezpiecznik zadziałał',
  'dealWatch.disableCta': 'Wyłącz obserwację okazji',
  'dealWatch.disableConfirmTitle': 'Wyłączyć obserwację okazji?',
  'dealWatch.disableConfirmBody': '„{label}” wróci do pierwotnego wyszukiwania i filtra ceny.',
  'dealWatch.disableConfirmPaused':
    'Detekcja jest wstrzymana — przywrócenie na stronie handlu wykona się po jej wznowieniu.',
  'dealWatch.broadQuery':
  ...
  'dealWatch.refreshEvery.15m': '15 minut',
