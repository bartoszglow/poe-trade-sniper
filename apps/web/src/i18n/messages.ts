...
export const EN = {
  ...
  'priceCheck.copyWhisper': 'Copy buy whisper',
  'priceCheck.priceIt': 'Price it',
  'priceCheck.min': 'min',
  'priceCheck.max': 'max',
  'priceCheck.includeFilter': 'Include in price',
  'priceCheck.unmatchedTitle': 'Not matched to a stat',
  'priceCheck.fixedValueNote':
    "Fixed-value item — priced from the aggregator; the stat filters don't apply.",
  'priceCheck.attr.itemLevel': 'Item level (min)',
  'priceCheck.attr.quality': 'Quality (min)',
  'priceCheck.attr.corrupted': 'Corrupted',
  'priceCheck.attr.baseType': 'Base type',
  ...
  'settings.hotkeyReset': 'Reset to default',
  ...
  'priceChecks.parseEdit': 'Parse & edit',
...
export const PL: Record<MessageKey, string> = {
  ...
  'priceCheck.copyWhisper': 'Kopiuj whisper zakupu',
  'priceCheck.priceIt': 'Wyceń',
  'priceCheck.min': 'min',
  'priceCheck.max': 'maks',
  'priceCheck.includeFilter': 'Uwzględnij w wycenie',
  'priceCheck.unmatchedTitle': 'Niedopasowane do statystyki',
  'priceCheck.fixedValueNote':
    'Przedmiot o stałej wartości — wyceniany z agregatora; filtry statystyk nie mają zastosowania.',
  'priceCheck.attr.itemLevel': 'Poziom przedmiotu (min)',
  'priceCheck.attr.quality': 'Jakość (min)',
  'priceCheck.attr.corrupted': 'Skażony',
  'priceCheck.attr.baseType': 'Typ bazowy',
  ...
  'settings.hotkeyReset': 'Przywróć domyślny',
  ...
  'priceChecks.parseEdit': 'Wczytaj i edytuj',
